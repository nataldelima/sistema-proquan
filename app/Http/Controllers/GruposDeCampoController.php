...
class GruposDeCampoController extends Controller
{
    ...
    public function gerarPDFIndividual($id)
    {
        try {
            ...
            $pdf = PDF::loadView('grupos-campo-report-individual', $data);
            ...
            return redirect()->route('grupos-campo')->with('error', 'Não foi possível gerar o PDF.');
        }
    }
    ...
    public function gerarPDF()
    {
        try {
            ...
            $pdf = PDF::loadView('grupos-campo-report-all', $data);
